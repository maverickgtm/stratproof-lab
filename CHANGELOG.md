...
- A one-click Quick Audit path with immediate, unrestricted operations-CSV verification.
...
- Paid-roadmap previews, quotas and pricing assets have been removed from the Community product surface.
- Evidence-report cards now limit their claims to values calculated by the audit engine.
...
- GitHub README positioning StratProof Lab as an evidence engine for trading strategies.
...
- Evidence Report Builder UI with closed-outcome winrate, Net R, drawdown, duplicate rate, same-candle ambiguity and verdict cards.
...
- AGPL-3.0-or-later license, future-options note, trademark policy, open-source boundaries, security policy, contributing guide, roadmap, and notice.
...
- This is a community preview, not a production operated service.
- Screenshots are public demo/concept assets generated for GitHub presentation.
- Future connectors are roadmap items unless explicitly implemented and tested.
