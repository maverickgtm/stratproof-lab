...
checks.append(text('readme_v2_positioning', Path('README.md'), ['Most trading strategies look good', 'open-source evidence workbench', 'public OHLCV candle downloads', 'audit-only by design', 'Unrestricted CSV evidence downloads'], ['guaranteed' + ' profit', 'risk-' + 'free returns']))
...
md += ['','## Safety boundary','No GitHub publication, broker execution or external secrets were used in this test stage.']
