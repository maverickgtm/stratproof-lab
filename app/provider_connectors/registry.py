...
PROVIDERS = [
    ...
    {"key":"deribit","name":"Deribit","asset_classes":["crypto_derivatives"],"capabilities":["historical_ohlcv_future","options_data_future"],"edition":"Pro Roadmap","execution_default":"disabled"},
    ...
    {"key":"hyperliquid","name":"Hyperliquid","asset_classes":["crypto_derivatives"],"capabilities":["historical_ohlcv_future","trades_import_future"],"edition":"Pro Roadmap","execution_default":"disabled"},
    ...
    {"key":"interactive_brokers","name":"Interactive Brokers","asset_classes":["stocks","forex","futures","options"],"capabilities":["historical_ohlcv","account_export_import"],"edition":"Pro Roadmap","execution_default":"disabled"},
    {"key":"polygon_io","name":"Polygon.io","asset_classes":["stocks","crypto","forex","options"],"capabilities":["historical_ohlcv","ticks_future"],"edition":"Pro Roadmap","execution_default":"not_applicable"},
    {"key":"alpaca","name":"Alpaca Markets","asset_classes":["stocks","crypto"],"capabilities":["historical_ohlcv","account_export_import"],"edition":"Pro Roadmap","execution_default":"disabled"},
    {"key":"mt4_mt5","name":"MT4 / MT5 Import","asset_classes":["forex","cfds","indices","commodities"],"capabilities":["history_import","trade_export_import"],"edition":"Pro Roadmap","execution_default":"disabled"},
    {"key":"oanda_fxcm","name":"Oanda / FXCM Import","asset_classes":["forex","cfds"],"capabilities":["historical_ohlcv_future","account_export_import_future"],"edition":"Pro Roadmap","execution_default":"disabled"},
    {"key":"fix_fast","name":"FIX/FAST Enterprise","asset_classes":["multi_asset"],"capabilities":["institutional_data_pipeline_future"],"edition":"Enterprise Roadmap","execution_default":"disabled"},
    {"key":"cqg_rithmic_tt","name":"CQG / Rithmic / Trading Technologies","asset_classes":["futures"],"capabilities":["institutional_data_import_future"],"edition":"Enterprise Roadmap","execution_default":"disabled"},
]


def list_providers(include_premium: bool = True):
    if include_premium:
        return PROVIDERS
